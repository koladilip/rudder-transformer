          ...
          output: [
            {
              ...
              metadata: [
                { jobId: 4, destInfo: { ***REMOVED*** }, userId: 'u1' },
                { jobId: 5, destInfo: { ***REMOVED*** }, userId: 'u1' },
                { jobId: 6, destInfo: { ***REMOVED*** }, userId: 'u1' },
              ],
              batched: true,
              statusCode: 200,
              destination: {
            ...
            },
            {
              ...
              metadata: [
                { jobId: 1, destInfo: { ***REMOVED*** }, userId: 'u1' },
                { jobId: 2, destInfo: { ***REMOVED*** }, userId: 'u1' },
                { jobId: 3, destInfo: { ***REMOVED*** }, userId: 'u1' },
              ],
              batched: true,
              statusCode: 200,
              destination: {
            ...
            },
            {
              ...
              metadata: [
                { jobId: 7, destInfo: { ***REMOVED*** }, userId: 'u1' },
              ],
              batched: false,
              statusCode: 200,
              destination: {
            ...
            },
            {
              ...
              metadata: [
                { jobId: 8, destInfo: { ***REMOVED*** }, userId: 'u1' },
              ],
              batched: false,
              statusCode: 200,
              destination: {
